...
{*     {block name='cart_totals'}
    ...
    {block name='cart_actions'}
        {if $cart.minimalPurchaseRequired}
          ...
          <button  class="form-button action-disabled"  disabled>{l s='Checkout' d='Shop.Theme.Actions'}</button>
        {elseif empty($cart.products)}
          <button  class="form-button action-disabled" disabled>{l s='Checkout' d='Shop.Theme.Actions'}</button>
        {else}
          <a href="{$urls.pages.order}" class="checkout cart-checkout">{l s='Checkout' d='Shop.Theme.Actions'}</a>
