...
{block name='step_content'}
        ...
        <div>
          <div id="{$option.id}-container" class="payment-option">
            ...
            <form method="GET" class="ps-hidden-by-js">
              ...
              {else}
                <button class="form-button" class="ps-hidden-by-js" type="submit" name="select_payment_option" value="{$option.id}">
  ...
  <div id="payment-confirmation">
    <div class="ps-shown-by-js">
      <button class="form-button" type="submit" {if !$selected_payment_option} disabled {/if}>
      ...
      {if $show_final_summary}
        <article class="notification notification-danger js-alert-payment-conditions" role="alert" data-alert="danger">
          {l
            ...
            sprintf=[
            '[1]' => '<a class="action-default" href="#checkout-payment-step">',
            '[/1]' => '</a>',
            '[2]' => '<a class="action-default" href="#conditions-to-approve">',
            '[/2]' => '</a>'
            ]
