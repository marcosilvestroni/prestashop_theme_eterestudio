...
{block name='step_content'}
  <div class="js-address-form">
    ...
    {elseif $customer.addresses|count > 0}
      ...
      <a class="action-default" href="{$new_address_delivery_url}">{l s='Add a new address' d='Shop.Theme.Actions'}</a>

      {if $use_same_address && !$cart.is_virtual}
        <p>
          <a data-link-action="different-invoice-address" href="{$use_different_address_url}" class="action-default">
    ...
    {if !$use_same_address}
      ...
      {else}
        ...
        <a class="action-default" href="{$new_address_invoice_url}">{l s='Add a new address' d='Shop.Theme.Actions'}</a>
    ...
    {if !$form_has_continue_button}
      <button type="submit" class="continue form-button" name="confirm-addresses" value="1">
