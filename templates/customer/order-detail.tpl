...
<div class=" my-account-content detail-order">
  {block name='order_infos'}
    <div id="order-infos"  >
      ...
      {if $order.details.reorder_url}
        <a class="action-primary" href="{$order.details.reorder_url}">{l s='Reorder' d='Shop.Theme.Actions'}</a>
      {/if}
      ...
      {if $order.details.invoice_url}
        <p><a class="action-default" href="{$order.details.invoice_url}">{l s='Download your invoice as a PDF file.' d='Shop.Theme.Customeraccount'}</a></p>
      {/if}
  ...
  {block name='order_follow_up'}
    {if $order.follow_up}
      ...
      <a class="action-default" href="{$order.follow_up}">{$order.follow_up}</a>
    {/if}
  {/block}
