      ...
      <tbody>
        {foreach from=$orders item=order}
          <tr>
            ...
            <td>
              <a class="action-default action-primary" href="{$order.details.details_url}" data-link-action="view-order-details">
                {l s='Details' d='Shop.Theme.Customeraccount'}
              </a>
              {if $order.details.reorder_url}
                <a href="{$order.details.reorder_url}" class="order-reorder-link action-default">{l s='Reorder' d='Shop.Theme.Actions'}</a>
              {/if}
            </td>
          </tr>
        {/foreach}
