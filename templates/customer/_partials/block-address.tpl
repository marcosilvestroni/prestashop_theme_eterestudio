    ...
    {block name='address_block_item'}
      <footer class="actions address-actions">
        <ul class="action-list">
          <li>
            <a class="action-default action-primary" href="{url entity=address id=$address.id}" data-link-action="edit-address">
              {l s='Update' d='Shop.Theme.Actions'}
            </a>
          </li>
          <li>
            <a class="action-default "href="{url entity=address id=$address.id params=['delete' => 1, 'token' => $token]}" data-link-action="delete-address">
