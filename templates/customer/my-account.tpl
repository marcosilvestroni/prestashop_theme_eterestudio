...
{block name='page_content_container'}
  <section id="content" class="page-content page-my-account my-account-content">
    ...
    {block name="account_link_list"}
      <ul class="link-list">
        ...
        {if $customer.id_default_group==4}
          <li>
            <a id="dealer-link" href="{$urls.pages.dealer}">{l s='Dealer Page' d='Shop.Theme.Customeraccount'}</a>
          </li>
        {/if}

          <li>
            <a href="{$logout_url}" title="Logout" rel="nofollow" style=display:block;>lOGOUT</a>
          </li>
